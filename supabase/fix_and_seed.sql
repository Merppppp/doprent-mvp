-- ===========================================================
-- DopRent — Fix และใส่ข้อมูลทั้งหมด (รันครั้งเดียวจบ)
-- ===========================================================

-- ขั้นแรก: แก้ bug ที่เจอเมื่อกี้
alter table boutiques drop constraint if exists boutiques_area_key_fkey;

-- ขั้นสอง: ลบข้อมูลเก่าที่อาจเข้าครึ่งทาง
delete from dresses;
