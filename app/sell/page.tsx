  ...
  return (
    <div className="shell" style={{ paddingTop: 60, paddingBottom: 80 }}>
      ...
      <div style={{ maxWidth: 720, margin: "64px auto 0" }}>
        ...
        <Faq q="KYC คืออะไร?" a="ขั้นตอนยืนยันตัวตน ส่งบัตรประชาชน/หนังสือรับรองบริษัท + เลขบัญชีธนาคาร ใช้เวลา 24-72 ชม. ผ่านแล้วได้ ✓ verified badge" />
